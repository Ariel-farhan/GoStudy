          ...
          <div className="hidden lg:flex flex-col justify-center p-10 bg-gradient-to-br from-[#0A1024] to-[#090B18]">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
                Create your account and start learning smarter with AI-powered
                summaries, chat, and your own intelligent workspace.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center p-6 sm:p-8 lg:p-10">
            <div className="w-full max-w-sm">
              ...
              <div className="mb-6 text-center lg:text-left">
                ...
                <p className="text-gray-400 text-sm">Start your AI learning journey today</p>
              </div>
